...
var scene = new Image();
scene.src = "images/gamebackground2.jpg";
...
function startGame() {
    ...
    obstacle1.src = "images/plane1.png";
    ...
    obstacle2.src = "images/plane2.png";
    ...
    popsiclepoints.src = "images/popsicleorg.png";
    ...
    function displayResults() {
        ...
        document.getElementById('test').innerHTML = "Game Over. Your Score was " + score +  ". Please enter your name to be added to our players list.";
